...
//***********************************************************************************************
//dynamic array for storing page files, maintains reverse sorted order on insert

typedef struct Sorted_mem_pages sorted_mem_pages;
//len is number of elements, alloc len is the number of elements that can fit in allocated memory
